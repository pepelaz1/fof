...
class PreLollipopFlashlight : AbstractFlashlight() {
     ...
     */
    private var flashlightObservable =  createFlashlightObservable()

    fun createFlashlightObservable() :  Observable<Int?> {
    ...
    override fun onPermissionGranted() {
        flashlightObservable = createFlashlightObservable()
    }
